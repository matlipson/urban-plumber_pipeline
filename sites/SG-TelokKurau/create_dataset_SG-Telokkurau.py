...
def import_obs(sitedata,siteattrs):
    ...
    fpath_obs = f'{datapath}/{sitename}/Urban-PLUMBER_Singapore_eddy_covariance_fluxes.xls'

    # read data csv
    print('reading raw data file')
    raw = pd.read_excel(fpath_obs, na_values=-999, sheet_name='30-min data')

    # get times from data and reindex
    times = pd.date_range(start='2015-03-01 00:30:00', end='2016-03-01 00:00:00', freq='30Min')
    raw.index = times
